...
//
// [My answer here]
// The way that output is represented can be a bit missleading at first.
// 255 for example, which corresponds to -1 with 2:s complement.
//
// C) Inner workings.
//
...
//
// [My answer here]
// It will pick the latest modified ".ll" file found within the file system
//
