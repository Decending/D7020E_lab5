...
//
// [My answer here]
// The variables have been optimized out of the local environment.
//
...
//
// [My answer here]
// The calculation for time simply over / underflowed, by using a wrapping
// subtraction we get no errors.
//
